    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route
            path={'/admin/chartofaccount'}
            exact
            component={ChartofaccountTablePage}
          />
          <Route
            path={'/admin/chartofaccount/new'}
            exact
            component={ChartofaccountFormPage}
          />
          <Route
            path={'/admin/chartofaccount/:id/edit'}
            exact
            component={ChartofaccountFormPage}
          />
          ...
          <Route
            path={'/admin/itemgroup'}
            exact
            component={ItemgroupTablePage}
          />
          <Route
            path={'/admin/itemgroup/new'}
            exact
            component={ItemgroupFormPage}
          />
          <Route
            path={'/admin/itemgroup/:id/edit'}
            exact
            component={ItemgroupFormPage}
          />
          ...
          />
          <Route
            path={'/admin/salesorder/new'}
            exact
            component={SalesorderFormPage}
          />
          <Route
            path={'/admin/salesorder/:id/edit'}
            exact
            component={SalesorderFormPage}
          />

          <Route
            path={'/admin/salesorderdetails'}
            exact
            component={SalesorderdetailsTablePage}
          />
          <Route
            path={'/admin/salesorderdetails/new'}
            exact
            component={SalesorderdetailsFormPage}
          />
          <Route
            path={'/admin/salesorderdetails/:id/edit'}
            exact
            component={SalesorderdetailsFormPage}
          />
        </Switch>
