module.exports = {
    ...
    async up(queryInterface, Sequelize) {
        ...
        try {
                    ...
                    await queryInterface.createTable('chartofaccount', {
                        id: {
                            type: Sequelize.DataTypes.UUID,
                            defaultValue: Sequelize.DataTypes.UUIDV4,
                            primaryKey: true,
    ...
    async down(queryInterface, Sequelize) {
        ...
        try {
                    ...
                    await queryInterface.dropTable('chartofaccount', { transaction });

                    await queryInterface.dropTable('item', { transaction });
